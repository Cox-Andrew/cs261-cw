...
public class Feedback implements FeedbackInterface {
	...
	@Override
	public FeedbackAttendeeInfo getAttendeeFeedback(int eventID, int attendeeID) throws MoodlysisInternalServerError, MoodlysisNotFound {
			...
			*/
			...
			do {
				...
				|| rs.getInt("attendeeID") != submissionInfo.attendeeID || rs.getInt("eventFormID") == genFeedEventFormID)) {
					...
					feedbackAttendeeInfo.list.add(submissionInfo);
				...
				answerInfo.moodValue = rs.getDouble("value");
				if (rs.wasNull())
